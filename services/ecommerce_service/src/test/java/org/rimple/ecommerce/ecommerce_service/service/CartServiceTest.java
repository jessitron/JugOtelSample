...
public class CartServiceTest {
    ...
    public void shouldAddNewItemToCart() {
        Cart cart = cartService.updateQuantityInCart("user123", testProduct.getId(), 2);
    ...
    public void shouldIncreaseQuantityIfItemExists() {
        cartService.updateQuantityInCart("user123", testProduct.getId(), 2);
        Cart updated = cartService.updateQuantityInCart("user123", testProduct.getId(), 3);
    ...
    public void shouldSetExactQuantity() {
        cartService.updateQuantityInCart("user123", testProduct.getId(), 1);
    ...
    public void shouldRemoveItemIfQuantityIsZero() {
        cartService.updateQuantityInCart("user123", testProduct.getId(), 1);
        Cart updated = cartService.updateQuantityInCart("user123", testProduct.getId(), 0);
